...
from train_yolo_v8_seg.utils.ikutils import prepare_dataset
import os
import yaml
from ultralytics import YOLO
from datetime import datetime
import torch
from train_yolo_v8_seg.utils import custom_callbacks
...
# --------------------
class TrainYoloV8SegParam(TaskParam):
    ...
    def __init__(self):
        ...
        self.cfg["model_name"] = "yolov8m-seg"
        self.cfg["epochs"] = 100
...
# --------------------
class TrainYoloV8Seg(dnntrain.TrainProcess):

    def __init__(self, name, param):
        dnntrain.TrainProcess.__init__(self, name, param)
        # Create parameters class
        if param is None:
            self.set_param_object(TrainYoloV8SegParam())
        else:
...
# --------------------
class TrainYoloV8SegFactory(dataprocess.CTaskFactory):
    ...
    def create(self, param=None):
        ...
        return TrainYoloV8Seg(self.info.name, param)
