...
from train_yolo_v8_seg.train_yolo_v8_seg_process import TrainYoloV8SegParam
...
# --------------------
class TrainYoloV8SegWidget(core.CWorkflowTaskWidget):

    def __init__(self, param, parent):
        core.CWorkflowTaskWidget.__init__(self, parent)

        if param is None:
            self.parameters = TrainYoloV8SegParam()
        else:
...
# --------------------
class TrainYoloV8SegWidgetFactory(dataprocess.CWidgetFactory):

    def __init__(self):
        dataprocess.CWidgetFactory.__init__(self)
        # Set the name of the process -> it must be the same as the one declared in the process factory class
        self.name = "train_yolo_v8_seg"

    def create(self, param):
        # Create widget object
        return TrainYoloV8SegWidget(param, None)
